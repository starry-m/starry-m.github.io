...
![](/img/post_img/f280049c/ADC触发.png)
其他的就只是通道选择和参考源选择。
...
![](/img/post_img/f280049c/PI控制器.png)
我这里还没有把控制参数调到最佳。
...
5V带载输出
![](/img/post_img/f280049c/现象2.png)
串口改变输出电压为6V
![](/img/post_img/f280049c/现象3.png)
6V空载
![](/img/post_img/f280049c/现象4.png)
增大输入电压
![](/img/post_img/f280049c/现象5.png)
